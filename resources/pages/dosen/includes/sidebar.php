    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 flex flex-col justify-between">  
        <div>  
            ...
            <ul class="space-y-2 font-medium">  
                <li>  
                    <a href="home"  
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white <?php echo (basename($_SERVER['PHP_SELF']) == 'dashboard.php') ? 'bg-gray-100 dark:bg-gray-700' : ''; ?> hover:bg-gray-100 dark:hover:bg-gray-700 group">  
                ...
                <li>  
                    <a href="Mahasiswa"  
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white <?php echo (basename($_SERVER['PHP_SELF']) == 'mahasiswa.php') ? 'bg-gray-100 dark:bg-gray-700' : ''; ?> hover:bg-gray-100 dark:hover:bg-gray-700 group">  
                ...
                <li>  
                    <a href="hasil_presensi"  
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white <?php echo (basename($_SERVER['PHP_SELF']) == 'hasil_presensi.php') ? 'bg-gray-100 dark:bg-gray-700' : ''; ?> hover:bg-gray-100 dark:hover:bg-gray-700 group">  
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"  
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"  
                            viewBox="0 0 16 20">  
                            <path  
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Hasil Presensi</span>  
                    </a>  
                </li>  
        ...
        <!-- Logot (Logout) at the bottom -->  
        <div class="mt-auto">  
            <a href="logout"  
                class="flex inset-x-0 bottom-0 items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">  
                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"  
